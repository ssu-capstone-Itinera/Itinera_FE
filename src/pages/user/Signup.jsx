        ...
        <Container>
            <Wrapper>
                ...
                <InputContainer>
                    ...
                    <Input name="email" placeholder="itinera@example.com" onChange={handleChange} />
                </InputContainer>
                <InputContainer>
                    <InputTitle> 아이디 </InputTitle>
                    <Input name="userName" type="userName" placeholder="사용하실 아이디를 입력해주세요" onChange={handleChange} />
                </InputContainer>
                <InputContainer>
                    <InputTitle> 비밀번호 </InputTitle>
                    <Input name="password" placeholder="영어 대소문자, 특수문자를 포함하여 8자리 이상" onChange={handleChange} />
                </InputContainer>
